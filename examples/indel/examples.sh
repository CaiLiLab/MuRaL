...
mural_indel train  --ref_genome data/seq.fa --train_data data/training.sorted.bed --experiment_name example1 > test1.out 2> test1.err

# After training, one can run the following command to get the best model per trial
mural_indel get_best_model ./results/example1/Train_*/progress.csv
...
mural_indel train --ref_genome data/seq.fa --train_data data/training.sorted.bed --validation_data data/validation.sorted.bed  --distal_radius 4000 --n_trials 3 --experiment_name example2 > test2.out 2> test2.err
