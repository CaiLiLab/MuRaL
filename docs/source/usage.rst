...
.. note::
  ...
  scheduling. If execute multiple trials serially or running only a single trial (set ``--cpu_per_trial=1``), 
...
First, adjust ``--central_region`` (default is 300,000, means maximum encoding unit of the 
...
to 50,000 at the cost of an acceptable loss in data preprocessing speed. 
...
.. image:: images/RAM_memory_usage.jpg
   :width: 830px
