...
class Network7(nn.Module):
    ...
    def __init__(self,  emb_dims, no_of_cont, lin_layer_sizes, emb_dropout, lin_layer_dropouts, in_channels, out_channels, kernel_size, distal_radius, distal_order, distal_fc_dropout, n_class, emb_padding_idx=None):
        ...
        self.maxpool1 = nn.MaxPool1d(maxpool_kernel_size//2, maxpool_stride//2) # kernel_size, stride  
        self.conv2 = nn.Sequential(    
            nn.BatchNorm1d(out_channels),
            nn.Conv1d(out_channels, out_channels, kernel_size),
            #nn.ReLU(),
...
class Network9(nn.Module):
    ...
    def __init__(self,  emb_dims, no_of_cont, lin_layer_sizes, emb_dropout, lin_layer_dropouts, in_channels, out_channels, kernel_size, distal_radius, distal_order, distal_fc_dropout, n_class, emb_padding_idx=None):
        ...
        # 1st set of residual blocks
        self.RBs1 = nn.Sequential(*[ResBlock(out_channels, kernel_size=rb1_kernel_size, stride=1, padding=(rb1_kernel_size-1)//2, dilation=1) for x in range(3)])
        ...
        # 2nd set of residual blocks
        self.RBs2 = nn.Sequential(*[ResBlock(out_channels, kernel_size=rb2_kernel_size, stride=1, padding=(rb2_kernel_size-1)//2, dilation=1) for x in range(3)])
...
class Network12(nn.Module):
    ...
    def __init__(self,  emb_dims, no_of_cont, lin_layer_sizes, emb_dropout, lin_layer_dropouts, in_channels, out_channels, kernel_size, distal_radius, distal_order, distal_fc_dropout, n_class, emb_padding_idx=None):
        ...
        # 2nd set of residual blocks
        self.RBs2 = nn.Sequential(*[ResBlock(out_channels*2, kernel_size=rb2_kernel_size, stride=1, padding=(rb2_kernel_size-1)//2, dilation=1) for x in range(4)])

        self.maxpool2 = nn.MaxPool1d(4, 4)
        self.conv3 = nn.Sequential(
            nn.BatchNorm1d(out_channels*2),
            nn.Conv1d(out_channels*2, out_channels*4, kernel_size),
            nn.ReLU(),
        )
        
        cnn_fc_in_size = out_channels * 7
