...
data_local, data_distal, categorical_features = separate_local_distal(data, radius=5)
data_local_test, data_distal_test, categorical_features = separate_local_distal(data_test, radius=5)
...
model = Network(emb_dims, no_of_cont=n_cont, lin_layer_sizes=[100, 50], emb_dropout=0.2, lin_layer_dropouts=[0.1, 0.1], in_channels=4, out_channels=20, kernel_size=12, RNN_hidden_size=15, RNN_layers=1, last_lin_size=25).to(device)
