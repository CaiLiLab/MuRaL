...
y_prob_train = pd.Series(data=fit.predict_proba(X)[:,1], name="prob")
data_and_prob_train = pd.concat([X_data, y_data, y_prob_train], axis=1)
...
print ('5mer correlation - train: ' + str(f5mer_comp(data_and_prob_train)))
